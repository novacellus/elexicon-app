...
(: 
 ...
 : templating.
 :)
import module namespace config="http://scriptores.pl/lexicon/config" at "config.xqm";
(:import module namespace app="http://scriptores.pl/lexicon/templates" at "app.xql";:)

declare option exist:serialize "method=html5 media-type=text/html enforce-xhtml=yes";

(: KN: import modułów:)
(:import module namespace app_search="http://exist-db.org/xquery/apps/lexicon/search" at "xmldb:exist:///db/apps/lexicon/modules/app_search.xql";
import module namespace app_browse="http://exist-db.org/xquery/apps/lexicon/browse" at "xmldb:exist:///db/apps/lexicon/modules/app_browse.xql";
import module namespace app_view="http://exist-db.org/xquery/apps/lexicon/view" at "xmldb:exist:///db/apps/lexicon/modules/app_view.xql";:)
